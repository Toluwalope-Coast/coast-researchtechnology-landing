            ...
            <section className="contact-section">
                <div className="contact-container">
                    ...
                    <div className="attach">
                        <Image src="/phone.png" alt="Phone" className="phone" width={1000} height={1000} />
                        <Image src="/headset.png" alt="Headset" className="headset" width={1000} height={1000} />
                    </div>
                    <div className="contact-content">
                        <form>
                            <input type="text" name="name" placeholder="Name" required />
                            <input type="email" name="email" placeholder="Email" required />
                            <textarea name="message" placeholder="Please enter details of your message" required></textarea>
                ...
                <div className="map">
                    <iframe
                        ...
                        width="800" height="400" loading="lazy"></iframe>
                </div>
            </section>
        </main>
